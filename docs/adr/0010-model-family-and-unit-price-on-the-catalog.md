...
- An unfiltered or very broad view (>30 matches) shows no prices at all until narrowed — a real gap versus the original "eventually cache-warms the whole catalog" intent, accepted as the cost of not hammering the rate limiter on every page load.
